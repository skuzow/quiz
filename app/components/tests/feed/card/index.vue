...
<template>
  <NuxtLinkLocale
    :to="`/tests/${test.id}`"
    :title="test.title"
    class="flex cursor-pointer flex-col overflow-hidden rounded-xl border bg-card text-card-foreground shadow transition-all duration-200 hover:-translate-y-0.5 hover:bg-secondary/50 hover:shadow-md sm:flex-row"
  >
